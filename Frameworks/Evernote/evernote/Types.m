...
- (id) initWithId: (int32_t) id width: (int16_t) width height: (int16_t) height advertiserName: (NSString *) advertiserName imageUrl: (NSString *) imageUrl destinationUrl: (NSString *) destinationUrl displaySeconds: (int16_t) displaySeconds score: (double) score image: (NSData *) image imageMime: (NSString *) imageMime html: (NSString *) html displayFrequency: (double) displayFrequency openInTrunk: (BOOL) openInTrunk
{
  ...
  __height = height;
  __height_isset = YES;
  __advertiserName = [advertiserName retain_stub];
  __advertiserName_isset = YES;
  __imageUrl = [imageUrl retain_stub];
  __imageUrl_isset = YES;
  __destinationUrl = [destinationUrl retain_stub];
  ...
  __image_isset = YES;
  __imageMime = [imageMime retain_stub];
  __imageMime_isset = YES;
  __html = [html retain_stub];
  __html_isset = YES;
...
- (id) initWithCoder: (NSCoder *) decoder
{
  ...
  {
    __advertiserName = [[decoder decodeObjectForKey: @"advertiserName"] retain_stub];
    __advertiserName_isset = YES;
  }
  ...
  {
    __destinationUrl = [[decoder decodeObjectForKey: @"destinationUrl"] retain_stub];
    __destinationUrl_isset = YES;
  }
  ...
  {
    __imageMime = [[decoder decodeObjectForKey: @"imageMime"] retain_stub];
    __imageMime_isset = YES;
  }
  if ([decoder containsValueForKey: @"html"])
  {
    __html = [[decoder decodeObjectForKey: @"html"] retain_stub];
    __html_isset = YES;
  }
...
- (void) dealloc
{
  [__advertiserName release_stub];
  [__imageUrl release_stub];
  [__destinationUrl release_stub];
  [__image release_stub];
  [__imageMime release_stub];
  [__html release_stub];
  [super dealloc_stub];
}
...
- (NSString *) advertiserName {
  return [[__advertiserName retain_stub] autorelease_stub];
}

- (void) setAdvertiserName: (NSString *) advertiserName {
  [advertiserName retain_stub];
  [__advertiserName release_stub];
...
- (NSString *) destinationUrl {
  return [[__destinationUrl retain_stub] autorelease_stub];
}

- (void) setDestinationUrl: (NSString *) destinationUrl {
  [destinationUrl retain_stub];
  [__destinationUrl release_stub];
...
- (NSString *) imageMime {
  return [[__imageMime retain_stub] autorelease_stub];
}

- (void) setImageMime: (NSString *) imageMime {
  [imageMime retain_stub];
  [__imageMime release_stub];
...
- (NSString *) html {
  return [[__html retain_stub] autorelease_stub];
}
