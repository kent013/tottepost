...
- (void)drawInContext:(CGContextRef)context
{
	...
	CGContextSetFillColorWithColor(context, [UIColor colorWithWhite:0.963 alpha:0.5].CGColor);
	CGContextFillRect(context, CGRectMake(knobCenter, 0, self.bounds.size.width - knobCenter, self.bounds.size.height));

	// knob shadow
	CGContextSetShadowWithColor(context, CGSizeMake(0, 0), 1.5, [UIColor colorWithWhite:0.2 alpha:0.5].CGColor);
	CGContextSetStrokeColorWithColor(context, [UIColor colorWithWhite:0.42 alpha:0.5].CGColor);
